...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 6, vars: 2, consts: [[1, "wrapper"], ["title", "COVID-19", "description", "Um painel para acompanhar os dados em tempo real"], [1, "container"], [1, "row"], ["class", "col-6 col-md-3", 4, "ngFor", "ngForOf"], ["class", "last-update", 4, "ngIf"], [1, "col-6", "col-md-3"], [3, "content"], [1, "last-update"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], inputs: { title: "title", description: "description" }, decls: 5, vars: 2, template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
